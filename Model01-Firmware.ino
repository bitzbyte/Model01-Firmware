...
enum { PRIMARY, OOB_QWERTY, FUNCTION, OOB_FUNCTION, NUMPAD }; // layers
...
#define PRIMARY_KEYMAP_MAC_DVORAK
// #define PRIMARY_KEYMAP_QWERTY
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,      Key_F1,          Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_LEDEffectNext,
   ...
   ___,                       Consumer_ScanNextTrack, TOPSY(Minus),             TOPSY(Equals),            Key_Minus,       Key_Equals,       Key_F12,
...
static kaleidoscope::plugin::LEDSolidColor solidWhite(60, 60, 60);
